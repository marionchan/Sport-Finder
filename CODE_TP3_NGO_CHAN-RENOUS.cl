...
(defparameter *BR* 
  '((R1 ((> taille 190) (sexe masculin)) (taille grande))
    ...
    (R44 ((pratique individuel) (qualite adresse)) (sport golf))
    (R45 ((pratique collectif) (silhouette moyenne) (qualite adresse) (qualite endurance)) (sport handball))
    (R46 ((pratique collectif) (silhouette large) (qualite adresse) (qualite endurance)) (sport handball))
    (R47 ((pratique collectif) (qualite adresse)) (sport volleyball))
    (R48 ((pratique collectif) (qualite force) (qualite endurance)) (sport waterpolo))
    (R49 ((pratique collectif) (qualite vitesse)) (sport ultimate))
    )
  )
